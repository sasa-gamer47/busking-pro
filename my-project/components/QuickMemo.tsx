    ...
    <Card className='bg-zinc-900 border-2 border-zinc-800 w-full min-h-44 h-full p-2 text-zinc-300 flex flex-col justify-center items-center'>
        ...
        <div className="w-full h-1/5 flex items-center justify-center">
            <div className="w-1/2 h-full flex justify-center items-center cursor-pointer">
                <Play className='text-orange-500' size={30} strokeWidth={2} />
                <p className='text-lg font-semibold ml-4'>Play</p>
            </div>
            <div className="w-1/2 h-full flex justify-center items-center cursor-pointer">
                <Save className='text-orange-500' size={30} strokeWidth={2} />
                <p className='text-lg font-semibold ml-4'>Salva</p>
            </div>
        </div>
    </Card>
  )
